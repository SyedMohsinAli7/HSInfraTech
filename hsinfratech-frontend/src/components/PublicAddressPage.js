          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><button onClick={() => { window.scrollTo({ top: 0, behavior: 'auto' }); setCurrentPage('public-address-system'); }} className="hover:text-white transition-colors">Public Address System</button></li>
              </ul>
            </div>
            <div>
