  ...
  return (
    <div className="min-h-screen flex flex-col justify-between bg-gradient-to-br from-blue-50 via-white to-gray-100">
      ...
      <section className="bg-red-50 py-12 text-center">
        ...
        <button onClick={() => setCurrentPage && setCurrentPage('consultation-form')} className="bg-red-600 text-white px-8 py-4 rounded-lg text-lg hover:bg-red-700 transition-colors font-semibold shadow">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><button onClick={() => { window.scrollTo({ top: 0, behavior: 'auto' }); setCurrentPage('fire-alarm-system'); }} className="hover:text-white transition-colors">Fire Alarm System</button></li>
              </ul>
            </div>
            <div>
